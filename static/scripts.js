...
$(document).ready(function() {
    ...
    let options = {
        center: {lat: 38.7436297, lng: -109.49931240000001}, // Arches National Park
...
function addMarker(place)
{
    ...
    google.maps.event.addListener(marker, 'click', function() {
        $.getJSON("/articles?geo="+place.postal_code, function(info) {
            var news = "<ul>";
            for (i=0; i<6; i++) {
                news+= "<li><a href=\"" + info[i]['link'] + "\">" + info[i]['title'] + "</a></li>";
            }
            news+="</ul>"
